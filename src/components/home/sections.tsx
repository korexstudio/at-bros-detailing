...
const CHAPTERS = [
  {
    ...
    kicker: "Chapter one",
    title: "Wash",
    body: "A high-alkaline foam soaks the bulk of the grime off before anything touches the car. Then a safe two-stage contact wash — the method that adds zero swirls.",
    slot: "Process — foam pre-rinse mid-wash (action shot)",
  },
  {
    id: "decontaminate",
    kicker: "Chapter two",
    title: "Decontaminate",
    body: "Iron remover dissolves the embedded fallout you can feel but not see. Clay pulls out the rest, returning the paint to glassy smooth.",
    slot: "Process — iron remover turning purple on a panel",
  },
  {
    id: "protect",
    kicker: "Chapter three",
    title: "Protect",
    body: "A hydrophobic ceramic sealant: a sacrificial layer against UV and the elements, rated for months of beading.",
    slot: "Process — water beading on freshly sealed paint",
  },
  {
    id: "interior",
    kicker: "Chapter four",
    title: "Interior",
    body: "Every surface cleaned, deep vacuum, compressed air into the seams, and a conditioner that brings plastics and leather back to OEM matte.",
    slot: "Process — interior mid-detail (steam or extraction)",
  },
] as const;

/** The four full-viewport process chapters. */
    ...
    <div data-section="process">
      {CHAPTERS.map((chapter, i) => (
        <section
          ...
          className="mx-auto flex min-h-[80svh] max-w-6xl items-center px-5 py-16 sm:px-8"
        >
          <div
          ...
          >
            <div data-parallax="media">
              <ImageSlot label={chapter.slot} aspect="aspect-[4/3]" />
            </div>
            <div data-parallax="copy">
              <p className="text-xs uppercase tracking-[0.3em] text-accent">
                {chapter.kicker}
